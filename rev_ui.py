...
"""
NOTE 
ketika mengganti parameter yg diterima class Ui_Form (awalnya seperti di line 18) ke QWidget
tambahkan fungsi __init__ dan jangan lupa inisiasi super() dan self.setupUI
"""
...
class Ui_Form(QtWidgets.QWidget):
    ...
    def setupUi(self, Form):
        ...
        # self.frame_9.setMinimumSize(QtCore.QSize(1800, 0))
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Count Diameter Cell"))
        self.label_7.setText(_translate("Form", "Graph"))
        self.label_15.setText(_translate("Form", "Result"))
    ...
    def layout_crop(self):
        ...
        self.img_crop = QtWidgets.QLabel(self.frame_19)
        self.img_crop.setText("")
        self.img_crop.setFrameShape(QtWidgets.QFrame.Box)
        self.img_crop.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.img_crop.setObjectName("img_label")
        self.verticalLayout_15.addWidget(self.img_crop)
        self.verticalLayout_7.addWidget(self.frame_19)
        # self.horizontalLayout_15.addWidget(self.frame_16)

    def update_img(self, img, label):
